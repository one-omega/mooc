...
import com.eo.mooc.service.edu.entity.*;
...
import com.eo.mooc.service.edu.mapper.*;
...
public class CourseServiceImpl extends ServiceImpl<CourseMapper, Course> implements CourseService {
    ...
    public IPage<CourseVo> selectPage(Long page, Long limit, CourseQueryVo courseQueryVo) {
        ...
        return baseMapper.selectPageByCourseQueryVo(pageParam, queryWrapper);
    ...
    public boolean removeCoverById(String id) {
        ...
        if (course != null) {
            ...
            if (!StringUtils.isBlank(cover)){
                return ossFileService.removeFile(cover).getSuccess();
            }
        }
        return false;
    }
